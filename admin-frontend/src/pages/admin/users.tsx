...
const SORTABLE_COLUMNS: { label: string; field: 'name' | 'loyaltyPoints' | 'createdAt' }[] = [
    { label: 'Họ tên', field: 'name' },
    { label: 'Điểm thưởng', field: 'loyaltyPoints' },
    { label: 'Ngày ĐK', field: 'createdAt' },
];

const UserTable: React.FC<UserTableProps> = ({ users, onToggleActive, onViewDetail, onSort, query }) => {
    ...
    const UserManagementPage: NextPageWithLayout = () => {
        ...
        const handleQueryChange = useCallback((newParams: Partial<UserQueryDto>) => {
            dispatch(setUserQuery({ ...query, ...newParams }));
        }, [dispatch, query]);
        ...
        const handleSort = (field: string) => {
            ...
            if (query.sortBy === field) {
                ...
                if (field === 'name') newSortOrder = 'asc';
                else newSortOrder = 'desc';
            }

            handleQueryChange({ page: 1, sortBy: field, sortOrder: newSortOrder });
        };
        ...
        return (
            <>
                ...
                <div className="p-8 bg-gray-50 min-h-screen">
                    ...
                    <UserFilter query={query} onFilterChange={handleQueryChange} />
